...
var aBookmark = new Object();
aBookmark.child = new Array();
allChildren.push(aBookmark);
var auxBookmark;
...
exports.getFoldersChildren = function (myFolderId){
	...
	for (var i=0; i < folderNode.childCount; ++i) {
		...
		//console.log('Push all Children = ' + title + " is a folder = " + this.ifSubFolder(childNode));
		//allChildren.push(childNode);
		//console.log("FOLDER = " + title + " is folder = "+ this.ifSubFolder(childNode));
		if (this.ifSubFolder(childNode)){	
			//console.log('Push '+childNode.title+ '(auxBookmark) to aBookmark ' + childNode.parent.title+"\r\n\r\n\r\n");		
			
			//console.log(childNode.title + "  parent is = " + childNode.parent.title + "\r\n\r\n\r\n");			
			auxBookmark = new Object();
			auxBookmark.uri = new Array();
			
			auxBookmark.folder = childNode.title;
			auxBookmark.parent = childNode.parent.title;
			aBookmark.child.push(auxBookmark);
			//console.log('Before ' + JSON.stringify(aBookmark));
			//console.log('Iterate over = ' + childNode.title);
			var aux = this.getFoldersChildren(id);
			console.log(JSON.stringify(aux));
		}
		else if(this.ifUri(childNode)){
			//console.log(childNode.title + " parent is = " + childNode.parent.title + "\r\n\r\n\r\n");
			auxBookmark.uri.push(childNode.title);
	...
	//console.log("A Bookmark = " + aBookmark.folder.title);
	//console.log("Bookmark = " + aBookmark.uri);
	//console.log('Push aBookmark ' +);
	
	//console.log(JSON.stringify(aBookmark));
	return allChildren; 
